...
<div class="alert alert-warning"> Free version doesn't support Math equations while importing Ms Word file. You can upgrade to <a href="https://eduline.co/?ref=<?php echo base_url();?>">Enterprise  Version</a> with OMML plugin to support math equations.</div>

...
<a href="<?php echo site_url('user/switch_group');?>" class="btn btn-danger"><?php echo $this->lang->line('change_group');?></a>
			...
			<div class="form-group">	  
				...
				<div class="form-group">	 
					...
					<input type="text"  name="first_name"  class="form-control"  value="<?php echo $result['first_name'];?>" readonly=readonly  placeholder="<?php echo $this->lang->line('first_name');?>"   autofocus>
			</div>
				<div class="form-group">	 
					<label for="inputEmail" class="sr-only"><?php echo $this->lang->line('last_name');?></label> 
					<input type="text"   name="last_name"  class="form-control"  value="<?php echo $result['last_name'];?>" readonly=readonly  placeholder="<?php echo $this->lang->line('last_name');?>"   autofocus>
			</div>
				<div class="form-group">	 

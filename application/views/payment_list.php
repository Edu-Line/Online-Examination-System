...
<br> 
		...
		?>	
	<div class="alert alert-warning"> Online Payment Gateway only support with '<a href="https://eduline.co/?ref=<?php echo base_url();?>">Edu-Line Enterprise  Version</a>'. Enterprise version support Paypal, 2Checkout, Payumoney and Paytm gateway(s)</div>

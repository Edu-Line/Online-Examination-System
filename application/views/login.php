<script class="login-panel panel panel-default">
alert('Viweing this means the developer has given you the link to access this trial software.\n\n\nAdministrative Login email: admin@eduline.com\nStudent login email: user2@eduline.com\n\nPassword (both) : eduline');
</script>

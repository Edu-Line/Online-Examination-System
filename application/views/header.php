<html lang="en">
  ...
  <title><?php echo $title;?></title>
	...
	<meta name="description" content="A digital tool that aims to promote the embracement of technology in the educational sector by lowering all costs and labor processes as possible.">
  <meta name="author" content="Edu-Line (Pvt)">

<!-- icon to be displayed on browser panel -->
	...
	?>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://eduline-zw.co"><?php echo $this->lang->line('savsoft_quiz');?></a>
          </div>
...
?>				 <li><a href="<?php echo site_url('quiz');?>"><?php echo $this->lang->line('quiz');?> <?php echo $this->lang->line('list');?></a></li>
			...
			?> <li><a href="<?php echo site_url('notification');?>"><?php echo $this->lang->line('notification');?></a></li>
			  ...
			  <?php 
				...
				if($logged_in['su']==1){
			?>
			<!-- Removing the payment until payment gateways are set-up
